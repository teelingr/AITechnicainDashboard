...
const TranscriptDownloadButton = ({ audio }) => {
  const handleDownload = () => {
    ...
    fetch('http://localhost:5000/transcript_download', {
      method: 'POST',
      headers: {
    ...
    return (
      <button className={styles.actionButton} onClick={handleDownload}>Download Transcript</button>
    );
  };
